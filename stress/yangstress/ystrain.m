...
[ux,uy,uz] = ydisp(x,y,z);

[uxxp,uyxp,uzxp] = ydisp(x+0.01,y,z);
[uxxm,uyxm,uzxm] = ydisp(x-0.01,y,z);
[uxyp,uyyp,uzyp] = ydisp(x,y+0.01,z);
[uxym,uyym,uzym] = ydisp(x,y-0.01,z);
[uxzp,uyzp,uzzp] = ydisp(x,y,z-0.01);
[uxzm,uyzm,uzzm] = ydisp(x,y,z+0.01);
