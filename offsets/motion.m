...
%%
file = file1;
rawdata = select_reference(file,file0);
data16 = new_time_series;
data18 = new_time_series;
%%
i = int16(1);
...
%%
east = (east18 - east16)*1000;
north = (north18 - north16)*1000;
vertical = (vertical18 - vertical16)*1000;
disp(file);
disp([east,north,vertical]');
disp([east,north,vertical]'/2);
%%
